...
CREATE TABLE terminology_data (term varchar(30), description varchar(1000));

INSERT into terminology_data(term, description) VALUES
    ('Acidity', 'The acidity of wine refers to its crispness and the activation of salivary glands. Not the same as titratable acidity (TA)'),
    ...
    ('Body', 'A tactile sensation describing the weight and fullness of wine in the mouth.. A wine can be described as light, medium, or full-bodied, which refers to the weight and fullness of the wine.'),
    ...
    ('Brettanomyce', 'This type of yeast is responsible for spoilage, and it creates distasteful flavors: barnyard, mousy, metallic, or bandaid-ish aromas'),
    ...
    ('Citric acid', 'Wines contain citric acid, a weak acid found in grapes. One of the three predominate acids in wine'),
    ...
    ('Cluster set', 'Overall formation of the grape cluster following flowering. Normal clusters will be fully formed, with very few "shot berries" (missing grapes) and having uniform grape size. (see fruit set)'),
    ('Cms', 'The court of master sommeliers. '),
    ('Complex', 'Wines with many flavors, nuances, or odors might be described as complex.'),
    ('Cork taint', 'Wines stored in moist or moldy locations might develop undesired aromas and flavors, known as cork taint. Often associated with wet cardboard or moldy basements'),
    ...
    ('Fruit set', 'Overall formation of the grape cluster following flowering. Normal clusters will be fully formed, with very few "shot berries" (missing grapes) and having uniform grape size. (see cluster set)'),
    ...
    ('Length', 'Tasters note the amount of time that flavors persist in the mouth after swallowing wine; a lingering sensation'),
    ...
    ('Mouth feel', 'Tasters will describe how wine feels on the palate,  it can be rough, smooth, velvety, or furry. '),
    ...
    ('Oaky', 'Tasting term denoting smells and flavors of vanilla, baking spices, coconut, mocha, or dill caused by barrel-aging'),
