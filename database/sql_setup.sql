...
INSERT into varietal_data(varietal_id, varietal_name)
VALUES (nextval('varietal_data_varietal_id_seq'), 'Auxerrois'),
...
(
    ...
    varietals  varchar(800)
);

INSERT into ava_data(ava_id, ava_name, location, climate, soils, topography, varietals)
VALUES (nextval('ava_data_ava_id_seq'), 'Columbia Gorge',
        ...
        'Albariño, Aglianico, Barbera, Cabernet Franc, Cabernet Sauvignon, Chardonnay, Dolcetto, Gamay Noir, Gewürztraminer, Grenache, Grüner Vertliner, Lemberger, Malbec, Marsanne, Merlot, Mourvedre, Muscat, Nebbiolo, Pinot Blanc, Pinot Gris, Pinot Noir, Primitivo, Riesling, Roussanne, Sangiovese, Sauvignon Blanc, Syrah, Tempranillo, Viognier, Zinfandel.'),
       (nextval('ava_data_ava_id_seq'), 'Columbia Valley',
       ...
       (nextval('ava_data_ava_id_seq'), 'The Rocks District of Milton-Freewater',
        ...
        'Cabernet Franc, Grenache, Malbec, Syrah, Tempranillo, Viognier.'),
       (nextval('ava_data_ava_id_seq'), 'Walla Walla Valley',
        ...
        'Barbera, Cabernet Franc, Cabernet Sauvignon, Carmenere, Chardonnay, Cinsault, Counoise, Dolcetto, Gewürztraminer, Malbec, Merlot, Nebbiolo, Petit Verdot, Pinot Noir, Sangiovese, Semillon, Syrah, Viognier.'),
       (nextval('ava_data_ava_id_seq'), 'Rogue Valley',
        ...
        'Cabernet Franc, Cabernet Sauvignon, Carmenere, Chardonnay, Chenin Blanc, Dolcetto, Gewürztraminer, Grenache, Malbec, Marsanne, Merlot, Montepulciano, Mourvedre, Müller-Thurgau, Muscat, Nebbiolo, Petit Verdot, Petite Sirah, Pinot Blanc, Pinot Gris, Pinot Noir, Pinotage, Primitivo, Riesling, Roussanne, Sangiovese, Sauvignon Blanc, Semillon, Syrah, Tannat, Tempranillo, Touriga Nacional, Vermentino, Viognier, Zinfandel.'),
       (nextval('ava_data_ava_id_seq'), 'Applegate Value',
        ...
        'Merlot, Cabernet Franc, Cabernet Sauvignon, Chardonnay, Marsanne, Petite Sirah, Primitivo, Riesling, Rousanne, Sangiovese, Syrah, Tempranillo, Viognier, Zinfandel.'),
       (nextval('ava_data_ava_id_seq'), 'Snake River Valley',
        ...
        'Cabernet Franc, Cabernet Sauvignon, Canadice, Chardonnay, Cinsault, Gewürztraminer, Grenache, Lemberger, Malbec, Merlot, Mourvedre, Riesling, Syrah.'),
       (nextval('ava_data_ava_id_seq'), 'Southern Oregon',
       ...
       (nextval('ava_data_ava_id_seq'), 'Umpqua Valley',
        ...
        'Albariño, Baco Noir, Cabernet Franc, Cabernet Sauvignon, Chardonnay, Dolcetto, Gewürztraminer, Graciano, Grenache, Malbec, Merlot, Muscat Canelli, Pinot Blanc, Pinot Gris, Pinot Noir, Riesling, Sauvignon Blanc, Semillon, Syrah, Tempranillo, Zinfandel.'),
       (nextval('ava_data_ava_id_seq'), 'Elkton Oregon',
        ...
        'Baco Noir, Chardonnay, Gewürz., Pinot Gris, Pinot Noir, Riesling, Syrah'),
       (nextval('ava_data_ava_id_seq'), 'Red Hill Douglas County',
       ...
       (nextval('ava_data_ava_id_seq'), 'Willamette Valley',
        ...
        'Auxerrois, Cabernet Sauvignon, Chardonnay, Dolcetto, Gamay Noir, Gewürztraminer, Grüner Veltliner, Marechal Foch, Melon, Müller-Thurgau, Muscat, Muscat Ottonel, Pinot Blanc, Pinot Gris, Pinot Meunier, Pinot Noir, Riesling, Sauvignon Blanc, Syrah, Tempranillo.'),
       (nextval('ava_data_ava_id_seq'), 'Chehalem Mountains',
        ...
        'Chardonnay, Gamay Noir, Gewürztraminer, Marechal Foch, Pinot Blanc, Pinot Gris, Pinot Noir, Riesling, Syrah'),
       (nextval('ava_data_ava_id_seq'), 'Dundee Hills',
        ...
        'Chardonnay, Melon de Bourgogne, Müller-Thurgau, Muscat Ottonel, Pinot Blanc, Pinot Gris, Pinot Meunier, Pinot Noir, Riesling.'),
       (nextval('ava_data_ava_id_seq'), 'Eola-Amity Hills',
        ...
        'Auxerrois, Chardonnay, Gamay Noir, Grüner Veltliner, Gewürztraminer, Pinot Blanc, Pinot Gris, Pinot Noir, Riesling, Sauvignon Blanc, Syrah, Tempranillo, Viognier.'),
       (nextval('ava_data_ava_id_seq'), 'Laurelwood District',
        ...
        'NULL', 'Pinot noir, Pinot gris, Chardonnay'),
       (nextval('ava_data_ava_id_seq'), 'Lower Long Tom',
        ...
        'NULL', 'Pinot noir,Chardonnay, Riesling, Pinot gris,Sauvignon blanc'),
       (nextval('ava_data_ava_id_seq'), 'McMinnville',
        ...
        'Pinot Blanc, Pinot Gris, Pinot Noir, Riesling, Syrah.'),
       (nextval('ava_data_ava_id_seq'), 'Ribbon Ridge',
        ...
        'Cab Sauvignon, Chardonnay, Gamay Noir, Gewürz., Pinot Noir, Pinot Gris, Riesling, Sauvignon Blanc.'),
       (nextval('ava_data_ava_id_seq'), 'Tualatin Hills',
        ...
        'NULL', 'Pinot noir, Pinot gris, Chardonnay, Gewürztraminer'),
       (nextval('ava_data_ava_id_seq'), 'Van Duzer Corridor',
        ...
        'The Van Duzer Corridor is an anomaly in the Coast Range through which oceanic winds funnel into the Valley, creating a cooling effect that occurs as early as 2:00 in the afternoon. This breeze dries out the vine canopy and decreases fungus pressure, making the area highly attractive for grape growing and supporting sustainable practices by drastically reducing the need for fungus spray. As a phenomenon of wind protection, the grape skins thicken, leading to an abundance of anthocyanins (color) and tannin.',
        'NULL', 'NULL', 'Pinot noir, Chardonnay, Pinot gris, Riesling, Pinot blanc, Sauvignon blanc'),
       (nextval('ava_data_ava_id_seq'), 'Yamhill-Carlton',
        ...
        'Chardonnay, Dolcetto, Gamay Noir, Gewürztraminer, Melon, Muscat, Muscat Ottonel, Pinot Blanc, Pinot Gris, Pinot Meunier, Pinot Noir, Riesling.');
...
(
    ...
    cases_produced varchar(255),
    source_file    varchar(255),
    run_date       date DEFAULT CURRENT_DATE
);

INSERT into bottle_data(bottle_id, winery_name, winery_id, year, wine_name, pct_alcohol, ta, ph, soils, varietals,
                        clones, clusters, aging_process, cases_produced, source_file)
VALUES (nextval('bottle_data_bottle_id_seq'), 'Origin', 'W-8', '2015', 'Pinot Noir', '13.0% ', 'NULL', 'NULL', 'NULL',
        'Sedimentary ', '943 ', '70% ', 'New & neutral French oak ', '99 ', '15_origin_johan.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Origin', 'W-8', '2016', 'Chenin Blanc', '13.2% ', '5.7 g/L ', '3.62 ',
        'NULL', 'Sedimentary ', 'NULL', 'NULL', 'Neutral French oak ', '49 ', '16+Chenin+Blanc+Tech.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Omero', 'W-7', '2016', 'Gamay Noir', '13.9% ', '7.3 g/L ', '3.40 ',
        'NULL', 'Sedimentary ', 'Oregon Heirloom ', '10% ', '10 months neutral French oak barriques ', '450 ',
        '16+Gamay+Noir.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'Cabernet Franc, Gamay Noir', '12.7% ',
        '5.8g/L ', '3.69 ', 'NULL', 'Sedimentary ', 'NULL', '75% ', 'neutral french oak ', '60 ',
        '16+Minimus+WV+Red.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Omero', 'W-7', '2016', 'Chardonnay', '13% ', '5.9 g/L ', '3.32 ', 'NULL',
        'Marine-Sedimentary, Alluvial, Volcanic, ', 'Mendoza, 108, Musqué, Old Wente, Espiquette ', 'NULL',
        '10 months in combination of 140L Chablis casks, half barrels and neutral French barrique ', '390 ',
        '16+Omero+Chard.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Omero', 'W-7', '2016', 'Gamay Noir', '13.9% ', '7.3 g/L ', '3.40 ',
        'NULL', 'Sedimentary ', 'Oregon Heirloom ', '10% ', '10 months neutral French oak barriques ', '450 ',
        '16GamayNoir.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'Pinot Noir', '12.8% ', '6.0 g/L ', '3.62 ',
        'NULL', 'NULL', 'Mariafeld, 943 ', '80% ', 'neutral French oak ', '149 ', '16_dict_johan_PN+.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'Chardonnay', '13.2% ', '5.4 g/L ', '3.36 ',
        'NULL', 'Sedimentary ', 'Mendoza ', 'NULL', 'neutral French oak ', '25 ', '16_no_Mother#24.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'NULL', '13.89% ', '6.3 g/L ', '3.48 ',
        'Pinot Noir, Gamay Noir and Trousseau Noir ', 'NULL', 'NULL', '40% ', 'neutral French oak barriques ', '70 ',
        '16_no_Noir#23+.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'Pinot Noir', '13.9% ', '5.0 g/L ', '3.45 ',
        'Pinot Blanc, Pinot Gris, Pinot Noir, Pinot “Gouges,” Pinot Meunier ', 'NULL', 'NULL', 'NULL',
        'Chestnut barriques, stainless steel ', '98 ', '16_no_Pinot#22+.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Origin', 'W-8', '2016', 'Pinot Noir', '13.69% ', '4.6 g/L ', '3.69 ',
        'NULL', 'Sedimentary ', 'NULL', 'NULL', 'neutral French oak ', '45 ', '16_origin_gouges.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Sauvignon Blanc', '14.8% ', 'NULL', '3.47 ',
        'NULL', 'NULL', 'NULL', 'NULL', 'Combination Amphorae & Acacia wood casks ', '150 ', '17+Amphorae+SB.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Chardonnay', '14.9% ', 'NULL', '3.69 ', 'NULL',
        'sedimentary ', 'NULL', 'NULL', 'neutral oak & new chestnut barriques ', '120 ', '17+Min+#25.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Chardonnay, Pinot Noir', '13.0% ', 'NULL',
        '3.51 ', 'NULL', 'varied ', 'NULL', '20% ', 'nuetral French oak ', '310 ', '17+MIn+WV+Red+Wine.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Müller-Thurgau, Riesling', '12.5% ', 'NULL',
        'NULL', 'NULL', 'Volcanic ', 'NULL', 'NULL', 'Acacia wood & stainless steel ', '110 ',
        '17+muller+thurgau+tech.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Omero', 'W-7', '2017', 'Chardonnay', '13.4% ', 'NULL', '3.6 ', 'NULL',
        'Varied ', 'Old Wenté, Calera, Musquet, Mount Eden, 108 ', 'NULL',
        'neutral French oak barriques, half barrels and 140L Chablis casks ', '200 ', '17+Omero+Chard.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Omero', 'W-7', '2017', 'Gamay Noir', '13.5% ', 'NULL', '3.34 ', 'NULL',
        'volcanic ', 'NULL', '10% ', 'Neutral oak ', '460 ', '17+Omero+Gamay.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Origin', 'W-8', '2017', 'Cabernet Franc', '13.6% ', 'NULL', '3.43 ',
        'NULL', 'basalt ', 'NULL', 'NULL', 'neutral French oak ', '75 ', '17+Origin+Cab+Franc.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Origin', 'W-8', '2017', 'Chardonnay, Sauvignon Blanc', '13.3% ', 'NULL',
        'NULL', '55% Sauvignon Blanc, 45% Chardonnay ', 'Sedimentary ', 'NULL', 'NULL', 'neutral oak ', '150 ',
        '17+Origin+SB+Chard.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'NULL', '13.7% ', 'NULL', 'NULL', 'NULL',
        'Varied ', 'NULL', 'NULL', '9 mnths in combination neutral oak, Acacia wood, Chestnut barriques & puncheons ',
        '110 ', '17+Rockwell.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Pinot Noir', '13.1% ', 'NULL', 'NULL', 'NULL',
        'Varied ', 'NULL', '30% ', 'Concrete ', '883 ', '17+Sans-soufre+PN.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Vermentino', '13.7% ', 'NULL', '3.41 ', 'NULL',
        'Volcanic ', 'NULL', 'NULL', 'Combination concrete and neutral oak/chestnut ', '210 ',
        '17+Vermentino+Tech.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Chardonnay', '14.1% ', 'NULL', '3.31 ', 'NULL',
        'basalt ', 'NULL', 'NULL', 'neutral French oak ', '80 ', '17Mendoza+Chard.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2017', 'Chardonnay', '13.6% ', 'NULL', '3.38 ', 'NULL',
        'sedimentary ', 'NULL', 'NULL', 'combination neutral & new French oak ', '30 ', '17MInCaleraChard.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2018', 'Cabernet Franc, Pinot Gris, Pinot Noir',
        '13.9% ', 'NULL', '3.45 ', 'NULL', 'NULL', 'NULL', '15% ', '10 months in neutral oak barriques & puncheons ',
        '400 ', '18WV+Red.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2018', 'Grenache, Syrah', '13.8% ', 'NULL', '3.42 ',
        '78% Grenache, 24% Syrah ', 'NULL', 'NULL', '20% ', '22 months in neutral French oak barriques ', '95 ',
        '18_dict_Gre-Syrah.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2018', 'Syrah', '13.9% ', 'NULL', '3.65 ',
        '100% Syrah ', 'Alluvial ', 'NULL', '90% ', '16 months in neutral French oak barriques ', '100 ',
        '18_MIN_SM3.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'Pinot Noir', '12.7% ', '5.8g/L ', '3.64 ',
        'NULL', 'Sedimentary ', 'unknown ', '25% ', 'neutral french oak ', '50 ', '1968+PN+Chehalem.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'Chardonnay', '12.9% ', 'NULL', 'NULL', 'NULL',
        'Sedimentary ', '108 ', 'NULL', 'second-filled french oak ', '14 ', '1984+Chard.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2019', 'Chardonnay, Sauvignon Blanc', '12.2% ', 'NULL',
        '3.35 ', '69% Chardonnay, 31% Sauvignon blanc ', 'NULL', 'NULL', 'NULL', '16 months in neutral French oak ',
        '70 cases ', '19_Helix_Caroline.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Omero', 'W-7', '2019', 'Pinot Gris', '12.9% ', 'NULL', '3.29 ',
        '100% Pinot Gris ', 'NULL', 'NULL', 'NULL', '7 months in neutral French oak barriques ', '140 ',
        '19_Omero_PG.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Alloro', 'W-1', '2017', 'Pinot Noir', ' 14.3% ', ' 6.10 g/L ', ' 3.61 ',
        'NULL', 'Laurelwood Series ', '35% Pommard, 37% - 777, 23% - 114, 5% - Wadenswil ', 'NULL', 'NULL',
        '1,700 cases ', 'AlloroEPN17 TechSheet.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Alloro', 'W-1', '2017', 'Pinot Noir', ' 14.2% ', ' 6.20 g/L ', ' 3.62 ',
        'NULL', 'Laurelwood Series ', '100% - Dijon 777 ', 'NULL', 'NULL', '300 cases ',
        'AlloroJusPN17 TechSheet.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Alloro', 'W-1', '2017', 'Riesling', ' 12.0% ', ' 8.50 g/L ', ' 2.92 ',
        'NULL', 'Laurelwood Series ', 'NULL', 'NULL', 'NULL', '100 cases ', 'AlloroRies17TechSheet.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2018', 'NULL', '12% ', 'NULL', '3.20 ',
        '100% Blaufränkisch ', 'Sedimentary ', 'NULL', 'NULL', 'NULL', '90 ', 'NV_dict_Blau_PétNat.json'),
       (nextval('bottle_data_bottle_id_seq'), 'Minimus', 'W-6', '2016', 'Chardonnay', '13.3% ', 'NULL', '3.42 ',
        '100% Chardonnay ', 'NULL', 'Old Wente, Espiguette ', 'NULL',
        '15 months to 3 years in 2nd fill and neutral French oak barriques ', '50 ', 'NV_Helix_Chardonnay.json');

/*== Terminology Data ==*/

DROP TABLE IF EXISTS terminology_data;
...
INSERT into terminology_data(term, description)
VALUES ('Acidity',
...
INSERT into winery_data(winery_id, winery_name, winemaker, address, phone_number, winery_url)
VALUES (nextval('winery_data_winery_id_seq'), 'Alloro', 'Tom Fitzpatrick',
        '22185 SW Lebeau Road, Sherwood, Oregon 97140', '503.625.1978', 'https://www.allorovineyard.com/'),
       (nextval('winery_data_winery_id_seq'), 'Anne Amie', 'GABRIELA SEPULVEDA VIGNES',
        '6580 NE Mineral Springs Rd., Carlton, OR 9711', '503.864.2991', 'https://anneamie.com/'),
       (nextval('winery_data_winery_id_seq'), 'Archery Summit', 'Ian Burch',
        '18599 NE Archery Summit RoadDayton, OR 97114', '503.714.2030', 'https://www.archerysummit.com/'),
       (nextval('winery_data_winery_id_seq'), 'Boedecker', 'Stewart Boedecker, Athena Pappas',
        '2621 NW 30th Avenue, Portland, OR 97210', '503.224.5778', 'https://boedeckercellars.com/'),
       (nextval('winery_data_winery_id_seq'), 'Ken Writght Cellars', 'Ken & Karen Wright',
        '236 N. Kutch St. Carlton, OR 97111', '503-852-7070', 'https://kenwrightcellars.com/'),
       (nextval('winery_data_winery_id_seq'), 'Minimus', 'NULL', '116 W Main St. Catlgon, OR 97111', '503.852.3033',
        'https://www.craftwineco.com/'),
       (nextval('winery_data_winery_id_seq'), 'Omero', 'NULL', '117 W Main St. Catlgon, OR 97111', '503.852.3034',
        'https://www.craftwineco.com/'),
       (nextval('winery_data_winery_id_seq'), 'Origin', 'NULL', '118 W Main St. Catlgon, OR 97111', '503.852.3035',
        'https://www.craftwineco.com/');
...
import secrets
    password ==secsecretsathe predominance of a unique soil series recognized as Laurelwood, found on the north- and east-facing slope of the Chehalem Mountains. The Laurelwood District AVA encompasses over 33,000 acres and includes the highest elevation in the Willamette Valley, at 1,633 feet. Laurelwood soil is composed of a 15-million-year-old basalt base with a loess (windblown freshwater silt) top layer accumulated over the past 200,000 years and at depths of 4’ to 0” depending on the elevation.',
        'NULL', 'Pinot noir, Pinot gris, Chardonnay'),
       (nextval('ava_data_ava_id_seq'), 'Lower Long Tom',
        'Established in November 2021, the Lower Long Tom AVA sits within the west side of the Lower Long Tom Watershed, between Corvallis and Eugene.',
        'To the west, the region is flanked by significantly higher elevations of the Coast Range which serve to form a weather shield. The rain shadow of the peaks to the west reduces precipitation and, combined with the prevailing winds, creates a macroclimate with less disease pressure during the growing season and consistent fruit maturity, even in more difficult vintages.',
